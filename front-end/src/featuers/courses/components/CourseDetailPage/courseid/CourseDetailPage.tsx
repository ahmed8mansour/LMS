                    ...
                    <div className="w-full lg:basis-8/13 xl:basis-10/13 flex flex-col gap-10">
                        <div className="course_hero">
                            <div className="rounded-xl overflow-hidden mb-6 relative group">
                                <div className="card_wimage w-full bg-cover bg-center h-[320px]" style={{backgroundImage: `linear-gradient(180deg, rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.7) 100%), url(${course.thumbnail})`}} >
                                </div>   
                                        ...
                                        <div className="flex flex-wrap items-center gap-6">
                                            <div className="flex items-center gap-2">
                                                <div className="flex items-center gap-0.5">
                                                    {Array.from({length:course.rating}).map((num) => ( // course.rating = 4.0 
                                                        <IoMdStarOutline
                                                            size={24}
